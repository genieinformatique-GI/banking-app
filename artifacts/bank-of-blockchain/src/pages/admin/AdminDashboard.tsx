...
export default function AdminDashboard() {
  ...
  return (
    <div className="space-y-8 animate-fade-in">
       ...
       <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
         <Card className="bg-card">
           ...
           <CardContent>
             ...
             <p className="text-xs text-muted-foreground mt-1">{t.admin.dashboard.outOf} {stats.totalUsers}</p>
           </CardContent>
         </Card>

         <Card className="bg-amber-500/5 border-amber-500/20">
           <CardHeader className="pb-2 flex flex-row items-center justify-between">
             <CardTitle className="text-amber-500 text-sm font-medium">{t.admin.dashboard.requiredAction}</CardTitle>
           ...
           <CardContent>
             ...
             <p className="text-xs text-amber-500/70 mt-1">{t.admin.dashboard.pendingItemsDesc}</p>
           </CardContent>
         </Card>

         <Card>
           <CardHeader className="pb-2 flex flex-row items-center justify-between">
             <CardTitle className="text-muted-foreground text-sm font-medium">{t.admin.dashboard.bankTransfersShort}</CardTitle>
         ...
         <Card>
           <CardHeader className="pb-2 flex flex-row items-center justify-between">
             <CardTitle className="text-muted-foreground text-sm font-medium">{t.admin.dashboard.cryptoTransfersShort}</CardTitle>
       ...
       <Card>
         <CardHeader>
           <CardTitle>{t.admin.dashboard.latestTransactions}</CardTitle>
         </CardHeader>

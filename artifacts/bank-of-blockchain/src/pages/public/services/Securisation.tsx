              ...
              <div style={{ background: "#f8f9fa", borderRadius: "12px", padding: "28px", marginBottom: "20px" }}>
                ...
                <ul className="space-y-2">
                  {[
                    ...
                    { label: "Sécurisation des investissements", href: "/nos-services/securisation-des-investissements", active: true },
                    ...
                    <li key={href}><Link href={href} style={{ display: "block", padding: "10px 14px", borderRadius: "6px", fontSize: "0.9rem", fontWeight: active ? 700 : 500, background: active ? "#225473" : "transparent", color: active ? "white" : "#555" }} className={active ? "" : "hover:bg-gray-200 transition-colors"}>{label}</Link></li>
                  ))}
                </ul>
              </div>
